389 22.4779C122.32 21.4527 120.936 20.9402 119.236 20.9402C117.536 20.9402 116.138 21.4527 115.041 22.4779C113.944 23.4753 113.396 24.7913 113.396 26.4259C113.396 28.0605 113.944 29.3904 115.041 30.4155C116.138 31.4129 117.536 31.9116 119.236 31.9116Z\" fill=\"#030953\"></path> <path d=\"M147.866 38.6441C145.536 38.6441 143.438 38.1592 141.574 37.1896C139.737 36.1922 138.298 34.8207 137.256 33.0753C136.215 31.3298 135.694 29.3488 135.694 27.1324C135.694 24.916 136.215 22.935 137.256 21.1896C138.298 19.4441 139.737 18.0865 141.574 17.1168C143.438 16.1194 145.536 15.6207 147.866 15.6207C150.197 15.6207 152.28 16.1194 154.117 17.1168C155.954 18.0865 157.394 19.4441 158.435 21.1896C159.477 22.935 159.998 24.916 159.998 27.1324C159.998 29.3488 159.477 31.3298 158.435 33.0753C157.394 34.8207 155.954 36.1922 154.117 37.1896C152.28 38.1592 150.197 38.6441 147.866 38.6441ZM147.866 33.3246C149.511 33.3246 150.855 32.7705 151.897 31.6623C152.966 30.5264 153.5 29.0164 153.5 27.1324C153.5 25.2485 152.966 23.7524 151.897 22.6441C150.855 21.5082 149.511 20.9402 147.866 20.9402C146.221 20.9402 144.864 21.5082 143.795 22.6441C142.726 23.7524 142.191 25.2485 142.191 27.1324C142.191 29.0164 142.726 30.5264 143.795 31.6623C144.864 32.7705 146.221 33.3246 147.866 33.3246Z\" fill=\"#030953\"></path> <path d=\"M49.4779 25C49.4779 38.8071 38.4019 50 24.739 50C11.076 50 0 38.8071 0 25C0 11.1929 11.076 0 24.739 0C38.4019 0 49.4779 11.1929 49.4779 25Z\" fill=\"#030953\"></path> <path d=\"M14.1905 9.55322H20.8527V33.1584H35.2874V38.6441H14.1905V9.55322Z\" fill=\"white\"></path></svg></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("header-nav",{ show: _vm.isBurger }))+">","</div>",[_vm._ssrNode("<ul>","</ul>",[_vm._ssrNode("<li class=\"header-nav-item\">","</li>",[_c('nuxt-link',{staticClass:"header-nav-item-link",attrs:{"exact":"","active-class":"active","to":"/#"}},[_vm._v("\n            Тендеры\n          ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"header-nav-item\">","</li>",[_c('nuxt-link',{staticClass:"header-nav-item-link",attrs:{"exact":"","active-class":"active","to":"/"}},[_vm._v("\n            Компании\n          ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"header-nav-item\">","</li>",[_c('nuxt-link',{staticClass:"header-nav-item-link",attrs:{"exact":"","active-class":"active","to":"/#"}},[_vm._v("\n            Продукты\n          ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"header-nav-item\">","</li>",[_c('nuxt-link',{staticClass:"header-nav-item-link",attrs:{"exact":"","active-class":"active","to":"/#"}},[_vm._v("\n            Кейсы\n          ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"header-nav-item\">","</li>",[_c('nuxt-link',{staticClass:"header-nav-item-link",attrs:{"exact":"","active-class":"active","to":"/#"}},[_vm._v("\n            Блог\n          ")])],1)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"header-login\">","</div>",[_c('nuxt-link',{staticClass:"header-nav-item-link",attrs:{"exact":"","active-class":"active","to":"/#"}},[_vm._v("\n        Вход и регистрация\n      ")])],1),_vm._ssrNode(" <div class=\"header-burger\"><span"+(_vm._ssrClass(null,{ cross: _vm.isBurger }))+"></span></div>")],2),_vm._ssrNode(" <hr>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Header.vue?vue&type=template&id=72e4acbe&
...
installComponents(component, {Header: __webpack_require__(13).default})
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".container{margin:0 100px;padding:0 36px}@media(max-width:700px){.container{margin:0;padding:0 10px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "header .header{height:95px;margin:0 100px;padding:0 36px;align-items:center}header .header,header .header ul{display:flex;justify-content:space-between}header .header ul{padding-left:0}header .header ul li{margin:0 20px;list-style-type:none;color:#030953;font-style:normal;font-weight:400;font-size:16px;text-decoration:none}header .header ul li:first-child{margin-left:0}header .header ul li:last-child{margin-right:0}header .header-login a,header .header ul li a{text-decoration:none}header .header-burger{display:none}header .active{opacity:.3}header hr{margin:0}@media(max-width:700px){header .header{margin:0;padding:0 10px}header .header .header-nav{display:none}header .header .show{display:block;position:absolute;top:88px;width:95%}header .header .show ul{background-color:#fff;flex-wrap:wrap}header .header .show ul li{margin:10px 40%}header .header .header-burger{display:block}header .header .header-burger .cross{transform:rotate(45deg)}header .header .header-burger .cross:after{transform:rotate(-90deg);top:0}header .header .header-burger span{display:block;width:25px;height:3px;background:#030953;position:relative}header .header .header-burger span:after{content:\"\";width:25px;height:3px;background:#030953;position:absolute;top:10px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(components_namespaceObject, "Company", function() { return Company; });
...
const _2a9eeb62 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 36)));

const _cbaa5712 = () => interopDefault(__webpack_require__.e(/* import() | pages/_id */ 2).then(__webpack_require__.bind(null, 37)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=39159b15&
var defaultvue_type_template_id_39159b15_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_vm._ssrNode("<main>","</main>",[_vm._ssrNode("<div class=\"container\">","</div>",[_c('Nuxt')],1)])],2)}
var defaultvue_type_template_id_39159b15_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=39159b15&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_39159b15_render,
  defaultvue_type_template_id_39159b15_staticRenderFns,
  false,
...
/* nuxt-component-imports */
installComponents(default_component, {Header: __webpack_require__(13).default})
...
const Company = () => __webpack_require__.e(/* import() | components/company */ 1).then(__webpack_require__.bind(null, 33)).then(c => wrapFunctional(c.default || c));
const Header = () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 13)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
